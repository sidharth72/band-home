        ...
        if search_req.status_code == 200:
            ...
            if data['artists']['items']:
                ...
                for genre in artist['genres']:
                    try:
                        existing_genre = models.Genre.objects.get(name=genre)
                        existing_genre.bands.add(form.instance)
                    except models.Genre.DoesNotExist:
                        new_genre = models.Genre.objects.create(name=genre)
                        new_genre.bands.add(form.instance)
