...
class Booking(models.Model):
	band = models.ForeignKey(Band, related_name='bookings', on_delete=models.CASCADE)
	...
	replaces = models.ForeignKey('Booking', null=True, blank=True, related_name='replacements', on_delete=models.CASCADE)
...
class TechnicalRequirement(models.Model):
	booking = models.ForeignKey(Booking, related_name="tech_req", on_delete=models.CASCADE)
